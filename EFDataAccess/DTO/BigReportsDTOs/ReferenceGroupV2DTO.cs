...
{ 
    public class ReferenceGroupV2DTO : IAgreggatedReportDTO
    {
        ...
        public int Development_Delay_Male { get; set; }
        public int Development_Delay_Female { get; set; }
        ...
        public List<Object> PopulatedValues()
        {
            ...
            values.Add(Development_Delay_Male);
            values.Add(Development_Delay_Female);
