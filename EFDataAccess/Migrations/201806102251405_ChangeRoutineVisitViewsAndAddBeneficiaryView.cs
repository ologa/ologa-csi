namespace EFDataAccess.Migrations
{
    ...
    public partial class ChangeRoutineVisitViewsAndAddBeneficiaryView : DbMigration
    {
        public override void Up()
        {
            ...
            Sql(@"CREATE VIEW Beneficiary as 
						...
						CASE WHEN a.RegistrationDate IS NULL THEN h.RegistrationDate ELSE 0 END As RegistrationDate
						from Adult a					
						...
						CASE WHEN c.RegistrationDate IS NULL THEN h.RegistrationDate ELSE 0 END As RegistrationDate
						from Child c
