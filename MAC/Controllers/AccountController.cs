...
using MAC.ViewModels.Authentication;
using EFDataAccess;
using MAC.Controllers;
...
namespace Authentication.Controllers
{
    public class AccountController : BaseController
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            User userFound = UserService.findUserByUsernameAndPassword(model.Username, model.Password);


            if (userFound != null)
            {
                FormsAuthentication.SetAuthCookie(model.Username, false);
                string roles = String.Join(",", userFound.UserRoles.Select(r => r.Role.Description).ToList());
                var authTicket = new FormsAuthenticationTicket(1, userFound.Username, DateTime.Now, DateTime.Now.AddHours(1), false, roles);
                ...
                { return RedirectToAction("Index", "SiteOverview"); }
            }
            else
            {
